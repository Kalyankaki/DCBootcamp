  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="app-muted border-b app-border text-center py-1.5 px-4 text-xs app-text-muted">
        🎓 Going deeper? Try <Link href="/demo-advanced" className="app-accent-text font-semibold hover:underline">Advanced Mode</Link> to design rows with MTBF and support contracts
      </div>
